...
function readURL(input) {
  if (input.files && input.files[0]) {
    ...
    reader.onload = function (e) {
      var _a;
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#preview-i').attr('src', ((_a = e === null || e === void 0 ? void 0 : e.target) === null || _a === void 0 ? void 0 : _a.result) || null);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#select-photo").hide();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#selected-image").show();
    };
    reader.readAsDataURL(input.files[0]);
  }
}
function ajaxGetSlug() {
  var text = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#menu-title').val();
  if (text != "") {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.REST_API_BASE + "/get-page-slug/" + text, function (data) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()("#ajaxSlug").html("/" + data);
    });
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#ajaxSlug").html("");
  }
}
})();
